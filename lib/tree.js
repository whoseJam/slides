...
export class Tree {
    ...
    show_boundary(show, animate = false) {
        ...
        this.vertex_list_.forEach((value) => { value.show_boundary(show, animate); });
    }
    ...
    opacity(new_opacity, animate = false) {
        this.vertex_list_.forEach((value) => { value.opacity(new_opacity, animate); });
        this.edge_list_.forEach((value) => { value.opacity(new_opacity, animate); });
    }
    ...
    maintain(animate = false) {
        ...
        this.vertex_list_.forEach((value) => {
            if (value.tree_mark_) {
                ...
                value.show_boundary(this.show_boundary_, animate);
            } else {
                value.radius(this.radius_);
                value.show_boundary(this.show_boundary_);
