...
export const Util = {
    ...
    locator: (loc) => {
        ...
        let begin = window.parent.document.getElementById("begin_" + loc);
        let end = window.parent.document.getElementById("end_" + loc);
        instance.cy = () => { return (begin.offsetTop + end.offsetTop) / 2; };
        instance.min_y = () => { return (begin.offsetTop); };
        instance.max_y = () => { return (end.offsetTop); };
        instance.y = () => { return instance.min_y(); };
        instance.my = () => { return instance.max_y(); };
        instance.height = () => { return instance.max_y() - instance.min_y(); }
        return instance;
    }
};
